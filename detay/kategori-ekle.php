...
$guncelle = null; // Tanımsız değişken hatası almayı önlemek için $guncelle'yi başlat

if (isset($_GET['islem']) && $_GET['islem'] == 'duzenle') {
    $guncelle = $db->query("select * from urun_kategori where id='{$_GET['id']}'")->fetch(PDO::FETCH_ASSOC);
}
...
<button class="btn btn-submit me-2" type="submit" name="kategori-guncelle">Kategori Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="kategori-ekle">Kategori Ekle</button>
