...
<div class="col-lg-12">
<div class="form-group">
<label>Hizmet ön Açıklama</label>
...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="hizmet-guncelle">Hizmet Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="hizmet-ekle">Hizmet Ekle</button>
