...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="video-guncelle">Video Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="video-ekle">Video Ekle</button>
