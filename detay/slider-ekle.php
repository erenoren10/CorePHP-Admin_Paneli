...
<div class="col-lg-12">
<div class="form-group">
<label>Slider ön Açıklama</label>
...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="slider-guncelle">Slider Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="slider-ekle">Slider Ekle</button>
