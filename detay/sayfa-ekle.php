...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="sayfa-guncelle">Sayfa Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="sayfa-ekle">Sayfa Ekle</button>
