...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="referans-guncelle">Referans Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="referans-ekle">Referans Ekle</button>
