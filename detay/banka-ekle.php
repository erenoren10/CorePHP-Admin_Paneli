<div class="page-wrapper">
    <div class="content">
        ...
        if ($_GET['islem'] == 'duzenle') {
            ...
            $guncelle = $db->query("select * from banka where id='{$_GET['id']}'")->fetch(PDO::FETCH_ASSOC);
        }
        ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <?php if ($_GET['islem'] == 'duzenle') { ?>
                                <button class="btn btn-submit me-2" type="submit" name="banka-guncelle">Banka
                                    Güncelle</button>
                                <input type="hidden" name="id" value="<?= $guncelle["id"] ?>">
                                <input type="hidden" name="link"
                                    value="../banka-ekle?islem=duzenle&id=<?= $guncelle["id"] ?>">

                            <?php } else { ?>
                                <input type="hidden" name="link" value="../<?= $seo ?>">

                                <button class="btn btn-submit me-2" type="submit" name="banka-ekle">Banka Ekle</button>
