...
<div class="col-lg-12">
<div class="form-group">
<label>Galeri ön Açıklama</label>
...
<div class="col-lg-12">
    <?php if($_GET['islem']=='duzenle'){?>
<button class="btn btn-submit me-2" type="submit" name="galeri-guncelle">Galeri Güncelle</button>
...
<button class="btn btn-submit me-2" type="submit" name="galeri-ekle">Galeri Ekle</button>
