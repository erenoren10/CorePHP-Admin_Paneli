					...
					<div class="row">
						<div class="col-lg-6 col-sm-6 col-12">
							<div class="form-group">
								<label>Ekibimiz Sırası</label>
								<input type="text" name="sira" value="<?= $guncelle["sira"] ?>">
							</div>
						</div>
						<div class="col-lg-6 col-sm-6 col-12">
							<div class="form-group">
								<label>Ekibimiz Adı</label>
						...
						<div class="col-lg-12 col-sm-12 col-12">
							<div class="form-group">
								<label>Ekibimiz Durum </label>
								<select class="select" name="durum">
									<option value="0" <?php if ($guncelle["durum"] == 0) {
										echo "selected";
									} ?>>Sitede Göster
									</option>
									<option value="1" <?php if ($guncelle["durum"] == 1) {
										echo "selected";
									} ?>>Sitede Gizle
									</option>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label>Ekibimiz ön Açıklama</label>
								<textarea class="form-control"
									name="onaciklama"> <?= $guncelle["onaciklama"] ?></textarea>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<label> Ekibimiz Resim</label>
							...
							<div class="form-group row col-md-12">
								<div class="col-md-4 " style="margin:auto;padding:auto;">
									<div class="uploaddis aktif" data-id="1" style="margin:0 auto;">
										<div class="upload1">
											<span class="metin" style="width: 100%;float: left;">Ekibimiz Resimi
												Yükle</span>
						...
						<div class="col-lg-12">
							<?php if ($_GET['islem'] == 'duzenle') { ?>
								<button class="btn btn-submit me-2" type="submit" name="ekibimiz-guncelle">Ekibimiz
									Güncelle</button>
								<input type="hidden" name="id" value="<?= $guncelle["id"] ?>">
								<input type="hidden" name="link"
									value="../ekibimiz-ekle?islem=duzenle&id=<?= $guncelle["id"] ?>">

							<?php } else { ?>
								<input type="hidden" name="link" value="../<?= $seo ?>">

								<button class="btn btn-submit me-2" type="submit" name="ekibimiz-ekle">Ekibimiz
									Ekle</button>
